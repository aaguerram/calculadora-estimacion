import { ETIQUETA_TIPO, NIVELES_COMPLEJIDAD, TIPOS_COMPONENTE } from '@/entities/estimation-model'
import type { CoeficientesModelo, NivelComplejidad, TipoComponente } from '@/entities/estimation-model'
import type { CoeficienteAEscribir, PropuestaCalibracion } from '@/entities/historical-project'
...
export function simularCambios(
  ...
  for (const cambio of cambios) {
    ...
    if (grupo === 'riesgo' && sub === 'sigma-comun') {
      ...
      resultado.integracion.porComplejidad[sub as NivelComplejidad] = cambio.valorPropuesto
    }
  }
